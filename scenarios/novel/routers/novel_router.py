"""
Novel Generation Scenario - API Router

Domain-specific API endpoints for novel CRUD operations.
Migrated from src/api/routers/novels.py as part of Phase 1 refactoring.

Data source: Database only (no filesystem dependency).
Endpoints: Novel list, chapter content, settings, import/export.
"""
...
from scenarios.novel.services.novel_service import NovelService
from scenarios.novel.services.import_service import ImportService
from scenarios.novel.models import ChapterStatus
