"""
Novel Generation Scenario - Import Service

Service for importing external novel files (txt format) into the database.
Migrated from src/api/services/import_service.py as part of Phase 1 refactoring.
"""
