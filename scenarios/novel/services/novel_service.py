"""
Novel Generation Scenario - Service Layer

Domain service for novel CRUD operations.
Migrated from src/api/services/novel_service.py as part of Phase 1 refactoring.
"""
...
import uuid
from scenarios.novel.models import Novel, Chapter, ChapterDraft, ChapterStatus, NovelSetting
