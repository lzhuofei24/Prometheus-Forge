...
from src.core.controller import RoutingRule
...
def _build_generate_chapter_rules() -> Dict[str, RoutingRule]:
    """生成新章节：start -> architect -> writer -> censor -> critic -> (media+knowledge | writer)"""
    return {
